...
$try -y mkdir -p fastqc_trimmed_output
...
$try -y echo "Aligning sequences with STAR..."
$try -y mkdir -p STAR_output
for sample in SRR10045016 SRR10045017 SRR10045018 SRR10045019 SRR10045020 SRR10045021; do
...
for sample in SRR10045016 SRR10045017 SRR10045018 SRR10045019 SRR10045020 SRR10045021; do
	$try -y htseq-count -n 1 STAR_output/${sample}/Aligned.out.sam genome/chr19_Homo_sapiens.GRCh38.95.gtf > htseq_output/$sample.csv
done

for sample in SRR10045016 SRR10045017 SRR10045018 SRR10045019 SRR10045020 SRR10045021; do
	$try -y cat htseq_output/$sample.csv >> htseq_output/SRR10045016-17-18-19-20-21_counts.csv
done
