...
$KOALA_SHELL "$scripts_dir/1.sh" "$inputs_dir" "$outputs_dir"

export BENCHMARK_SCRIPT="$scripts_dir/2.sh"
$KOALA_SHELL "$scripts_dir/2.sh" "$inputs_dir" "$outputs_dir"

export BENCHMARK_SCRIPT="$scripts_dir/3.sh"
$KOALA_SHELL "$scripts_dir/3.sh" "$inputs_dir" "$outputs_dir"
